        ...
        <div className="w-full h-[100vh]">
            {
                ...
                <main
                  ...
                  >
                    ...
                    <Form {...loginForm}>
                          <form onSubmit={loginForm.handleSubmit(onSubmitLogin)} className="space-y-8">
                            <h1 className="text-3xl font-semibold">Welcome to <span className="text-primary">N</span>Eats</h1>
                            <FormField
                  ...
                  <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src="https://plus.unsplash.com/premium_photo-1679518412552-15a169e9b576?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                    <Image
                      ...
                      width={1000}
                      height={1000}
                      src="https://images.unsplash.com/photo-1651440204227-a9a5b9d19712?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      className="absolute inset-0 h-full w-full object-cover opacity-80"
                    />
                  </section>
                <main
