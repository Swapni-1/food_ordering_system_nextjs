...
export default function AddUser({className,mutate}){
    ...
    return (
        <Dialog open={open} onOpenChange={handleDialogChange}>
            ...
            <Button className={className}>Add User</Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle className="text-center">Add a new user</DialogTitle>
              </DialogHeader>
              ...
              <Form {...userForm}>
                ...
                <FormField
                    ...
                    />
                    <Button type="submit" className="bg-primary shadow-md mt-2">Sign Up</Button>
                </form>
              </Form>
              </div>
            </DialogContent>
